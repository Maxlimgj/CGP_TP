...
{
	filename = "~/data/shapes/rocket_launcher2/rocket_explosion.ogg";
...
{
	textureName = "~/data/shapes/rocket_launcher2/smoke.png";
	useInvAlpha =  true;
...
{
	textureName = "~/data/shapes/rocket_launcher2/fire";
	useInvAlpha =  false;
...
{
	textureName = "~/data/shapes/rocket_launcher2/spark";
...
{
	textureName = "~/data/shapes/rocket_launcher2/smoke";
	useInvAlpha = false;
...
{
	projectileShapeName = "~/data/shapes/rocket_launcher2/rocket.dts";
...
function RocketProjectile::onCollision( %this, %obj, %col, %fade, %pos, %normal )
{
 ...
 echo("RocketProjectile::onCollision called! ----" @%col.getClassName() );
  if(%col.getClassName() $= "Player")
  {
         myPlayer.applyDamage(10);//boss damage
	 echo("Damage Done: 10");
         if (myPlayer.getState() $="Dead") 
               myPlayer.delete();
   ...
   if (%col.getState() !$="Dead")
         {       
           %col.applyDamage(200);//my damage
	   echo("Damage Dealt: 200");
         }
         else
         {
           //%col.delete();
...
{
	shapeFile = "~/data/shapes/rocket_launcher2/rocket launcher.dts";
...
datablock ShapeBaseImageData( RocketLauncherForSnorlaxImage )
{
	shapeFile = "~/data/shapes/rocket_launcher2/lastbossWeapon.dts";
...
function RocketLauncherForSnorlaxImage::onFire( %this, %obj, %slot )
{
	%projectile = %this.projectile;
